//#include ../cfb.js
cfb.Default.Class.jsonOnly = cfb.False;
var mod = new CfModule('types1', 'ns');
var cls0 = mod.addCls('cls0');
cls0.addProp('Prop0', cfb.Types.vt_bool);
