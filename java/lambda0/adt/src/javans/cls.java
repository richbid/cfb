...
public void Propc() {
//function-begin : public void Propc() @ javans.cls
	net.onelab.log.info("javans.cls.Propc()", "[enter]");
	Object step1 = (Runnable)()-> {};
	Object step2 = (Runnable)()-> {};
	Object step3 = (Runnable)()-> {};
//function-end
}

public int Func(net.onelab.ReturnBoolean aReturn) {
//function-begin : public int Func(net.onelab.ReturnBoolean aReturn) @ javans.cls
