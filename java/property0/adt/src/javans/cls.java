...
public int to_xml(StringBuilder output, String rowTag) {
	...
	if (output == null) output = new StringBuilder(); else output.setLength(0);
	output.append("<" + rowTag + ">" + "<PBool>" + mPBool.toString().replace("<", "&lt;").replace(">", "&gt;") + "</PBool>" + "<PBytes>" + mPBytes.toString().replace("<", "&lt;").replace(">", "&gt;") + "</PBytes>" + "<PDate>" + new SimpleDateFormat("yyyy/MM/dd").format(mPDate.getTime()).replace("<", "&lt;").replace(">", "&gt;") + "</PDate>" + "<PDateTime>" + new SimpleDateFormat("yyyy/MM/dd HH:mm:ss.SSS").format(mPDateTime.getTime()).replace("<", "&lt;").replace(">", "&gt;") + "</PDateTime>" + "<PDouble>" + mPDouble.toString().replace("<", "&lt;").replace(">", "&gt;") + "</PDouble>" + "<PFloat>" + mPFloat.toString().replace("<", "&lt;").replace(">", "&gt;") + "</PFloat>" + "<PInt32>" + mPInt32.toString().replace("<", "&lt;").replace(">", "&gt;") + "</PInt32>" + "<PText>" + mPText.replace("<", "&lt;").replace(">", "&gt;") + "</PText>" + "<PTime>" + new SimpleDateFormat("HH:mm:ss.SSS").format(mPTime.getTime()).replace("<", "&lt;").replace(">", "&gt;") + "</PTime>" + "<PUInt32>" + mPUInt32.toString().replace("<", "&lt;").replace(">", "&gt;") + "</PUInt32>" + "</" + rowTag + ">");
	return 1;
}
...
public int to_sv(StringBuilder output, String spliter) {
	...
	list.add(mPBytes.toString());
	list.add(new SimpleDateFormat("yyyy/MM/dd").format(mPDate.getTime()));
	list.add(new SimpleDateFormat("yyyy/MM/dd HH:mm:ss.SSS").format(mPDateTime.getTime()));
	list.add(mPDouble.toString());
	list.add(mPFloat.toString());
	list.add(mPInt32.toString());
	list.add(mPText);
	list.add(new SimpleDateFormat("HH:mm:ss.SSS").format(mPTime.getTime()));
