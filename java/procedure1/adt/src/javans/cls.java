...
public void Proc(Boolean aArgBool, net.onelab.Bytes aArgBytes, java.util.GregorianCalendar aArgDate, java.util.GregorianCalendar aArgDateTime, Double aArgDouble, Float aArgFloat, Integer aArgInt32, String aArgText, java.util.GregorianCalendar aArgTime, Integer aArgUInt32) {
//function-begin : public void Proc(Boolean aArgBool, net.onelab.Bytes aArgBytes, java.util.GregorianCalendar aArgDate, java.util.GregorianCalendar aArgDateTime, Double aArgDouble, Float aArgFloat, Integer aArgInt32, String aArgText, java.util.GregorianCalendar aArgTime, Integer aArgUInt32) @ javans.cls
	net.onelab.log.info("javans.cls.Proc(Boolean aArgBool, net.onelab.Bytes aArgBytes, java.util.GregorianCalendar aArgDate, java.util.GregorianCalendar aArgDateTime, Double aArgDouble, Float aArgFloat, Integer aArgInt32, String aArgText, java.util.GregorianCalendar aArgTime, Integer aArgUInt32)", "[enter]");
//function-end
}

public void _invoke_(String entry, String input, String output) {
	if (false){}
	else if (entry.equals("Proc")){
	}
}
