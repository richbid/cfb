...
namespace qtns {
	class cls {
		...
		public:
			virtual bool FuncBool();
			virtual onelab::Bytes FuncBytes();
			virtual QDate FuncDate();
			virtual QDateTime FuncDateTime();
			virtual double FuncDouble();
			virtual float FuncFloat();
			virtual int FuncInt32();
			virtual QString FuncText();
			virtual QTime FuncTime();
			virtual unsigned int FuncUInt32();
		public:
