...
namespace ns {
	class cls {
		...
		public:
			virtual int trigger(int* aReturn);
		private:
			int f0(int* aReturn);
			int f1(int* aReturn);
			int f2(int* aReturn);
			int ifx0(int* aReturn);
			int tfx(int* aReturn);
			int ffx(int* aReturn);
			int ifx1(int* aReturn);
			int tf0(int* aReturn);
			int tf1(int* aReturn);
			int tf2(int* aReturn);
			int sfx0(int* aReturn);
			int cfx(int* aReturn);
			int sfx1(int* aReturn);
			int cf0(int* aReturn);
			int cf1(int* aReturn);
			int cf2(int* aReturn);
			int wfx0(int* aReturn);
			int lfx(int* aReturn);
			int wfx1(int* aReturn);
			int lf0(int* aReturn);
			int lf1(int* aReturn);
			int lf2(int* aReturn);
			int if9(int* aReturn);
			int tf10(int* aReturn);
			int if10(int* aReturn);
			int lf10(int* aReturn);
		public:
