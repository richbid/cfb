...
namespace qtns {
	class cls {
		...
		public:
			~cls();
			cls();
			cls(const bool& aPBool, const onelab::Bytes& aPBytes, const QDate& aPDate, const QDateTime& aPDateTime, const double& aPDouble, const float& aPFloat, const int& aPInt32, const QString& aPText, const QTime& aPTime, const unsigned int& aPUInt32, ns::cls0* aPCls0);
		public:
