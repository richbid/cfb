...
int qtns::cls::FuncBool(bool* aReturn) {
//function-begin : int qtns::cls::FuncBool(bool* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncBool()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncBytes(onelab::Bytes* aReturn) {
//function-begin : int qtns::cls::FuncBytes(onelab::Bytes* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncBytes()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncDate(QDate* aReturn) {
//function-begin : int qtns::cls::FuncDate(QDate* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncDate()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncDateTime(QDateTime* aReturn) {
//function-begin : int qtns::cls::FuncDateTime(QDateTime* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncDateTime()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncDouble(double* aReturn) {
//function-begin : int qtns::cls::FuncDouble(double* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncDouble()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncFloat(float* aReturn) {
//function-begin : int qtns::cls::FuncFloat(float* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncFloat()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncInt32(int* aReturn) {
//function-begin : int qtns::cls::FuncInt32(int* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncInt32()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncText(QString* aReturn) {
//function-begin : int qtns::cls::FuncText(QString* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncText()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncTime(QTime* aReturn) {
//function-begin : int qtns::cls::FuncTime(QTime* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::FuncTime()", "[enter]");
	return 0;
//function-end
}

int qtns::cls::FuncUInt32(unsigned int* aReturn) {
//function-begin : int qtns::cls::FuncUInt32(unsigned int* aReturn) @ qtns.cls
