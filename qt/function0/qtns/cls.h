...
namespace qtns {
	class cls {
		...
		public:
			virtual int FuncBool(bool* aReturn);
			virtual int FuncBytes(onelab::Bytes* aReturn);
			virtual int FuncDate(QDate* aReturn);
			virtual int FuncDateTime(QDateTime* aReturn);
			virtual int FuncDouble(double* aReturn);
			virtual int FuncFloat(float* aReturn);
			virtual int FuncInt32(int* aReturn);
			virtual int FuncText(QString* aReturn);
			virtual int FuncTime(QTime* aReturn);
			virtual int FuncUInt32(unsigned int* aReturn);
		public:
