...
void qtns::cls::Proc(bool* aArgBool, onelab::Bytes* aArgBytes, QDate* aArgDate, QDateTime* aArgDateTime, double* aArgDouble, float* aArgFloat, int* aArgInt32, QString* aArgText, QTime* aArgTime, unsigned int* aArgUInt32) {
//function-begin : void qtns::cls::Proc(bool* aArgBool, onelab::Bytes* aArgBytes, QDate* aArgDate, QDateTime* aArgDateTime, double* aArgDouble, float* aArgFloat, int* aArgInt32, QString* aArgText, QTime* aArgTime, unsigned int* aArgUInt32) @ qtns.cls
	onelab::log::info("qtns::cls::Proc(bool* aArgBool, onelab::Bytes* aArgBytes, QDate* aArgDate, QDateTime* aArgDateTime, double* aArgDouble, float* aArgFloat, int* aArgInt32, QString* aArgText, QTime* aArgTime, unsigned int* aArgUInt32)", "[enter]");
//function-end
}
