...
void qtns::cls::Propc() {
//function-begin : void qtns::cls::Propc() @ qtns.cls
	onelab::log::info("qtns::cls::Propc()", "[enter]");
	auto step1 = [&,this]() mutable {};
	auto step2 = [&,this]() mutable {};
	auto step3 = [&,this]() mutable {};
//function-end
}

int qtns::cls::Func(bool* aReturn) {
//function-begin : int qtns::cls::Func(bool* aReturn) @ qtns.cls
	onelab::log::info("qtns::cls::Func()", "[enter]");
	auto step1 = [&,this]() mutable {};
	auto step2 = [&,this]() mutable {};
	auto step3 = [&,this]() mutable {};
	return 0;
