...
public class cls : ICloneable {
	...
	public csns.cls.MySize mPMySize { get; set; }

	public void setPMySize(csns.cls.MySize aPMySize) {
		mPMySize = aPMySize;
	}

	public csns.cls.MySize getPMySize() {
		 return mPMySize;
	}

	protected bool compare_to(cls aValue) {
		if (mPMySize != aValue.mPMySize) return false;
		return true;
	}

	protected void clone_from(cls aValue) {
		mPMySize = aValue.mPMySize;
	}
	...
	public cls(csns.cls.MySize aPMySize) {
		mPMySize = aPMySize;
	}
	...
	public virtual int input_field(String key, object value, bool _set_value) {
		...
		if (string.IsNullOrWhiteSpace(key) || value == null) return 0;
			...
			csns.cls.MySize v; Int32 v2; if (!Int32.TryParse(value.ToString(), out v2)) return 0; v = (csns.cls.MySize)v2;
			if (_set_value)
				mPMySize = v;
			result = 1;
		}
	...
	private static readonly string[] field_keys = new string[] { "PMySize",  };
	...
	public virtual int to_json(ref String output) {
		output = "{" + "\"PMySize\"" + ":" + "\"" + ((Int32)mPMySize).ToString() + "\"" + "}";
		return 1;
	}
	...
	public virtual int to_xml(ref String output, String rowTag) {
		...
		output = "<" + rowTag + ">" + "<PMySize>" + ((Int32)mPMySize).ToString().Replace("<", "&lt;").Replace("<", "&gt;") + "</PMySize>" + "</" + rowTag + ">";
		return 1;
	}
	...
	public virtual int to_sv(ref String output, String spliter) {
		...
		list.Add(((Int32)mPMySize).ToString());
