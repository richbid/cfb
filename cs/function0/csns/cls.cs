...
public class cls : ICloneable {
	...
	public virtual int FuncBool(ref Boolean aReturn) {
	//function-begin : public virtual int FuncBool(ref Boolean aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncBool()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncBytes(ref onelab.Bytes aReturn) {
	//function-begin : public virtual int FuncBytes(ref onelab.Bytes aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncBytes()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncDate(ref DateTime aReturn) {
	//function-begin : public virtual int FuncDate(ref DateTime aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncDate()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncDateTime(ref DateTime aReturn) {
	//function-begin : public virtual int FuncDateTime(ref DateTime aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncDateTime()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncDouble(ref Double aReturn) {
	//function-begin : public virtual int FuncDouble(ref Double aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncDouble()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncFloat(ref Single aReturn) {
	//function-begin : public virtual int FuncFloat(ref Single aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncFloat()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncInt32(ref Int32 aReturn) {
	//function-begin : public virtual int FuncInt32(ref Int32 aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncInt32()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncText(ref String aReturn) {
	//function-begin : public virtual int FuncText(ref String aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncText()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncTime(ref DateTime aReturn) {
	//function-begin : public virtual int FuncTime(ref DateTime aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncTime()", "[enter]");
		return 0;
	//function-end
	}

	public virtual int FuncUInt32(ref UInt32 aReturn) {
	//function-begin : public virtual int FuncUInt32(ref UInt32 aReturn) @ csns.cls
		onelab.log.info("csns.cls.FuncUInt32()", "[enter]");
		return 0;
	//function-end
	}
