...
public class cls : ICloneable {
	...
	public virtual csns.cls.MySize Func(ref csns.cls.MySize aArg) {
	//function-begin : public virtual csns.cls.MySize Func(ref csns.cls.MySize aArg) @ csns.cls
		onelab.log.info("csns.cls.Func(csns.cls.MySize aArg)", "[enter]");
		return (csns.cls.MySize)0;
	//function-end
	}
