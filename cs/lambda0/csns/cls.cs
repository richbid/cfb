...
public class cls : ICloneable {
	...
	public virtual void Propc() {
	//function-begin : public virtual void Propc() @ csns.cls
		onelab.log.info("csns.cls.Propc()", "[enter]");
		Action step1 = () => {};
		Action step2 = () => {};
		Action step3 = () => {};
	//function-end
	...
	public virtual int Func(ref Boolean aReturn) {
	//function-begin : public virtual int Func(ref Boolean aReturn) @ csns.cls
