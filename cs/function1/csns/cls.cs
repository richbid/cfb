...
public class cls : ICloneable {
	...
	public virtual Boolean FuncBool() {
	//function-begin : public virtual Boolean FuncBool() @ csns.cls
		onelab.log.info("csns.cls.FuncBool()", "[enter]");
		return false;
	//function-end
	}

	public virtual onelab.Bytes FuncBytes() {
	//function-begin : public virtual onelab.Bytes FuncBytes() @ csns.cls
		onelab.log.info("csns.cls.FuncBytes()", "[enter]");
		return new onelab.Bytes();
	//function-end
	}

	public virtual DateTime FuncDate() {
	//function-begin : public virtual DateTime FuncDate() @ csns.cls
		onelab.log.info("csns.cls.FuncDate()", "[enter]");
		return new DateTime();
	//function-end
	}

	public virtual DateTime FuncDateTime() {
	//function-begin : public virtual DateTime FuncDateTime() @ csns.cls
		onelab.log.info("csns.cls.FuncDateTime()", "[enter]");
		return new DateTime();
	//function-end
	}

	public virtual Double FuncDouble() {
	//function-begin : public virtual Double FuncDouble() @ csns.cls
		onelab.log.info("csns.cls.FuncDouble()", "[enter]");
		return 0.0;
	//function-end
	}

	public virtual Single FuncFloat() {
	//function-begin : public virtual Single FuncFloat() @ csns.cls
		onelab.log.info("csns.cls.FuncFloat()", "[enter]");
		return 0.0f;
	//function-end
	}

	public virtual Int32 FuncInt32() {
	//function-begin : public virtual Int32 FuncInt32() @ csns.cls
		onelab.log.info("csns.cls.FuncInt32()", "[enter]");
		return 0;
	//function-end
	}

	public virtual String FuncText() {
	//function-begin : public virtual String FuncText() @ csns.cls
		onelab.log.info("csns.cls.FuncText()", "[enter]");
		return "";
	//function-end
	}

	public virtual DateTime FuncTime() {
	//function-begin : public virtual DateTime FuncTime() @ csns.cls
		onelab.log.info("csns.cls.FuncTime()", "[enter]");
		return new DateTime();
	//function-end
	}

	public virtual UInt32 FuncUInt32() {
	//function-begin : public virtual UInt32 FuncUInt32() @ csns.cls
