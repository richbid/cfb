...
public class cls : ICloneable {
	...
	public virtual void Proc(Boolean aArgBool, onelab.Bytes aArgBytes, DateTime aArgDate, DateTime aArgDateTime, Double aArgDouble, Single aArgFloat, Int32 aArgInt32, String aArgText, DateTime aArgTime, UInt32 aArgUInt32) {
	//function-begin : public virtual void Proc(Boolean aArgBool, onelab.Bytes aArgBytes, DateTime aArgDate, DateTime aArgDateTime, Double aArgDouble, Single aArgFloat, Int32 aArgInt32, String aArgText, DateTime aArgTime, UInt32 aArgUInt32) @ csns.cls
		onelab.log.info("csns.cls.Proc(Boolean aArgBool, onelab.Bytes aArgBytes, DateTime aArgDate, DateTime aArgDateTime, Double aArgDouble, Single aArgFloat, Int32 aArgInt32, String aArgText, DateTime aArgTime, UInt32 aArgUInt32)", "[enter]");
	//function-end
	}
